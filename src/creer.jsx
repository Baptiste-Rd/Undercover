...
const CreerPage = () => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-950 to-black text-white">
      <h1 className="text-4xl font-bold">Page de Création</h1>
      <p className="mt-4 text-lg">Bienvenue sur la page de création de jeu.</p>
      ...
      <form class="max-w-xs mx-auto">
        ...
        <div class="relative flex items-center max-w-[11rem]">
          <button
            type="button"
            id="decrement-button"
            data-input-counter-decrement="joueurs-input"
